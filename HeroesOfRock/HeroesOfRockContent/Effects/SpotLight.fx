...
float3 S; //SpotLight Direction Vector
float LightAngleCos;
float LightHeight; //The Height of the Light(AKA It's FarPlane)
float2 GBufferTextureSize;
bool Shadows; //Shadows?
float shadowMapSize;
float DepthPrecision; //This is for modulating the Light's Depth Precision (100)
float DepthBias; //DepthBias for the Shadowing... (1.0f / 2000.0f)
...
sampler Cookie : register(s3); //Attenuation Cookie Sampler
sampler ShadowMap : register(s4); //ShadowMap sampler
