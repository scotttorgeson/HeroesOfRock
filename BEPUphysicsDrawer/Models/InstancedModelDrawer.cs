...
namespace BEPUphysicsDrawer.Models
{
    ...
    public class InstancedModelDrawer : ModelDrawer
    {
        ...
        public InstancedModelDrawer(GraphicsDevice device, System.IServiceProvider services)
            : base(device)
        {
            var resourceContentManager = new ResourceContentManager(services, DrawerResource.ResourceManager);
#if WINDOWS
        ...
        public override void Add(ModelDisplayObject displayObject)
        {
            ...
            var batchToAdd = new ModelDisplayObjectBatch(Device);
