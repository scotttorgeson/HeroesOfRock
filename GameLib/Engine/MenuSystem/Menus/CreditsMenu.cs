...
namespace GameLib.Engine.MenuSystem.Menus {
    public class CreditsMenu : GameMenu {
        ...
        public CreditsMenu (bool addMainMenuOnExit)
            ...
            rec = new Rectangle(Stage.renderer.GraphicsDevice.Viewport.Bounds.Center.X - credits.Width*3/4, Stage.renderer.GraphicsDevice.Viewport.Bounds.Bottom - credits.Height/8, credits.Bounds.Width*3/2, credits.Bounds.Height*2);
            scroll = rec.Y;
