...
namespace GameLib.Engine.MenuSystem.Menus {
    public class TutorialMenu : GameMenu {
        ...
        public TutorialMenu ()
            ...
            tut = Stage.Content.Load<Texture2D>("UI/Menu/tut");
        ...
        public override void Draw (float dt) {
            ...
            Stage.renderer.SpriteBatch.Draw(tut, new Rectangle(Renderer.ScreenRect.Center.X - 225, (int)MenuEntries[0].Position.Y + 50, 450, 450), Color.White);
        }
