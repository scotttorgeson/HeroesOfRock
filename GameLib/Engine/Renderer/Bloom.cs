...
namespace GameLib
{
    public class Bloom
    {
        ...
        public const float BloomThreshold = 0.5f;


        // Controls how much blurring is applied to the bloom image.
        // The typical range is from 1 up to 10 or so.
        public const float BlurAmount = 1.5f;


        // Controls the amount of the bloom and base images that
        // will be mixed into the final scene. Range 0 to 1.
        public const float BloomIntensity = 0.4f;
        public const float BaseIntensity = 1f;


        // Independently control the color saturation of the bloom and
        // base images. Zero is totally desaturated, 1.0 leaves saturation
        // unchanged, while higher values increase the saturation level.
        public const float BloomSaturation = 1f;
        public const float BaseSaturation = 1f;
        ...
        public void LoadContent()
        {
            ...
            bloomExtractEffect = Stage.Content.Load<Effect>("Effects/Bloom/BloomExtract");
            bloomCombineEffect = Stage.Content.Load<Effect>("Effects/Bloom/BloomCombine");
            gaussianBlurEffect = Stage.Content.Load<Effect>("Effects/Bloom/GaussianBlur");

            // Look up the resolution and format of our main backbuffer.
            PresentationParameters pp = Renderer.Instance.GraphicsDevice.PresentationParameters;
            ...
            sceneRenderTarget = new RenderTarget2D(Renderer.Instance.GraphicsDevice, width, height, false,
            ...
            renderTarget1 = new RenderTarget2D(Renderer.Instance.GraphicsDevice, width, height, false, format, DepthFormat.None);
            renderTarget2 = new RenderTarget2D(Renderer.Instance.GraphicsDevice, width, height, false, format, DepthFormat.None);
        }
        ...
        {
            Renderer.Instance.GraphicsDevice.SetRenderTarget(sceneRenderTarget);
        }
        ...
        public void Draw()
        {
            Renderer.Instance.GraphicsDevice.SamplerStates[1] = SamplerState.LinearClamp;
            ...
            Renderer.Instance.GraphicsDevice.SetRenderTarget(null);
            ...
            Renderer.Instance.GraphicsDevice.Textures[1] = sceneRenderTarget;
        ...
        {
            Renderer.Instance.GraphicsDevice.SetRenderTarget(renderTarget);
