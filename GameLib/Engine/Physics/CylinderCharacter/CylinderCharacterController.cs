...
namespace Physics.CylinderCharacter
{
    /// <summary>
    ...
    /// </summary>
    public class CylinderCharacterController : Updateable, IBeforeSolverUpdateable
    {
        /// <summary>
        ...
        public void Activate()
        {
            if (!IsUpdating)
            {
                //Stage.ActiveStage.GetQB<PhysicsQB>().RemoveFromSpace(this);
                IsUpdating = true;
                if (Body.Space == null)
                {
